    ...
    private async void Start()
    {
        ...
        switch (PlayMode)
        {
            case EPlayMode.EditorSimulateMode:
                ...
                await package.InitializeAsync(initParametersEditorSimulateMode).Task;
                break;
            case EPlayMode.OfflinePlayMode:
                var initParametersOfflinePlayMode = new OfflinePlayModeParameters();
                await package.InitializeAsync(initParametersOfflinePlayMode).Task;
                break;
            case EPlayMode.HostPlayMode:
                ...
                await initOperationHostPlayMode.Task;
